...
# Boundary conditions
R = 287
Tl = 297.8677  # inlet temperature (K)
Mal = 0.1892  # Mach number at inlet
p_inflow = 9.753431315656933e04  # inlet pressure (Pa)
p_outflow = 9.277211161772543e04  # back pressure (Pa)
...
if __name__ == "__main__":
    ...
    plt.tight_layout()
    plt.savefig("eulerquasi1d_subsonic.png")
